...
# The namse of the variables above don't give the readers much information and although there are not
# clues that result might used for.

# In programming languag, when we rewrite code to be more self documenting, we call this process 
